  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item"><a class="nav-link" href="/possystem/admin/createadmin.php">Create Admin</a></li>
...
<div class="container mt-4">
    ...
    <form method="post" class="row g-3">
        ...
        <div class="col-md-4">
            <button type="submit" name="create_staff" class="btn btn-success w-100">Create Staff</button>
        </div>
    </form>
</div>
